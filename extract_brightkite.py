...
traj = pd.read_csv('./Brightkite_totalCheckins.txt', sep='\t', names=['user', 'check_in_time', 'latitude', 'longitude', 'location_id'])
...
rel.to_csv('./brightkite.rel', index=False)
...
dyna.to_csv('./brightkite.dyna', index=False)
