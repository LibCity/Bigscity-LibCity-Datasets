...
outputdir = 'output/NYC_TAXI_Fhv_od'
util.ensure_dir(outputdir)

dataurl = 'input/NYC-Taxi/NYC-Taxi 2020-06/fhv_tripdata_2020-06.csv'
lookupurl = 'input/NYC-Taxi/taxi_zones/taxi_zones.shp'
dataname = outputdir+'/NYC_TAXI_Fhv'
