...
outputdir = 'output/PEMSD8'
util.ensure_dir(outputdir)

dataurl = 'input/PEMS08/'
dataname = outputdir+'/PEMSD8'

dataset = pd.read_csv(dataurl+'PEMS08.csv')
idset = set()
geo = []
...
dataset = np.load(dataurl+'PEMS08.npz')['data']  # (17856, 170, 3)

start_time = util.datetime_timestamp('2016-07-01T00:00:00Z')
end_time = util.datetime_timestamp('2016-9-01T00:00:00Z')
timeslot = []
...
config['info']['data_files'] = ['PEMSD8']
config['info']['geo_file'] = 'PEMSD8'
config['info']['rel_file'] = 'PEMSD8'
